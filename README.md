...
**Контейнеры** - это компактное виртуализованное окружение, которое предоставляет платформу для создания и запуска приложений. Контейнерам не требуется объем и издержки полной операционной системы.
